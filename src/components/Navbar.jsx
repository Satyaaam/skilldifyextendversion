  ...
  return (
    <div className="flex mx-auto justify-between items-center md:px-8 md:py-5 max-w-[1280px] ">
      ...
      <div className="hidden lg:flex flex-col text-white">
        <span className="have_question font-semibold">Have any questions?</span>
      ...
      <i
        ...
        className={`lg:hidden fa-solid  absolute text-white text-3xl right-5 ${
          show
      ...
      <div
        className={`show_div text-white absolute top-0 bottom-0 right-[0] w-[200px]  bg-opacity-60 backdrop-blur-md shadow-md ${
          show
